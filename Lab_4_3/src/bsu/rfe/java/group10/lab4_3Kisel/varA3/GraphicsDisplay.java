package bsu.rfe.java.group10.lab4_3Kisel.varA3;
...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ++i_n;
            // Убедиться, что точка находится в пределах области просмотра
            if (point[0] >= viewport[0][0] && point[1] <= viewport[0][1] && point[0] <= viewport[1][0]) {
                ...
                // Проверка условия для смены цвета
                int wholePart = point[1].intValue();
                if (wholePart % 2 == 0) { // Условие: целая часть значения функции - чётная
                    ...
                    for (int j = 0; j < 5; j++) {
                        double angle = Math.toRadians(j * 72);
                        ...
                        x = center.x + (radius / 2.5) * Math.cos(angle);
                        y = center.y - (radius / 2.5) * Math.sin(angle);
                        star.lineTo(x, y);
                    }
                    star.closePath();
    ...
    protected void paintDashes(Graphics2D canvas){
        ...
        for (int i = 0; i < 11; i++) {
            ...
            //X
            String plus_value_x = String.valueOf(roundToOneDecimal(stepX * i));
            ...
            //Y
            String plus_value_Y = String.valueOf(roundToOneDecimal(stepY * i));
            ...
            if (i != 0) {
                ...
                String minus_value_x = String.valueOf(roundToOneDecimal(-stepX * i));
                ...
                String minus_value_y = String.valueOf(roundToOneDecimal(-stepY * i));
