...
public class MainFrame extends JFrame {
    ...
    public Double calculate1(Double x, Double y, Double z) {
        return (Math.sin(Math.PI*Math.pow(y, 2))+Math.log(Math.pow(y, 2)))/(Math.sin(Math.PI*Math.pow(z, 2) + Math.sin(x) + Math.log(Math.pow(z, 2)) + Math.pow(x, 2) + Math.pow(Math.E, Math.cos(z*x))));
    }
